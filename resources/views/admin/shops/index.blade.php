                        ...
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-start justify-center gap-3">
                                    ...
                                    <x-delete-confirm-button identifier="{{ $shop->id }}"
                                        deleteUrl="{{ route('admin.shops.destroy', $shop->id) }}"
                                        message="Are you sure you want to delete this Item" tooltipText="Delete item" />
                                    <x-edit-button identifier="{{ $shop->id }}"
                                        editUrl="{{ route('admin.shops.edit', $shop->id) }}" tooltipText="Edit item" />
                                </div>
                            </td>
                        </tr>
                    @empty
