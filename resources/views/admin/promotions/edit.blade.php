...
@section('content')
    ...
    @endif
    <div class="p-4">
        <x-form-header :value="__('Update Promotion')" class="p-4" />

        <form class="w-full" action="{{ route('admin.promotions.update', $promotion->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid md:grid-cols-1 md:gap-6">
                ...
                <div>
                    ...
                    <x-text-input id="title" class="block w-full mt-1" type="text" name="title" value="{{ old('title', $promotion->title) }}"
            ...
            <div class="grid mt-4 md:grid-cols-3 md:gap-6">
                ...
                <div>
                    ...
                    <x-text-input id="start_date" class="block w-full mt-1" type="date" name="start_date"
                        value="{{ old('title', $promotion->start_date) }}" placeholder="Start Date" />
                    <x-input-error :messages="$errors->get('start_date')" class="mt-2" />
                </div>
                <div>
                    <x-input-label for="end_date" :value="__('End Date')" />
                    <x-text-input id="end_date" class="block w-full mt-1" type="date" name="end_date" value="{{ old('title', $promotion->end_date) }}"
            ...
            <div>
                ...
                <!-- Description -->
                    <div class="mb-5">
                        ...
                        <textarea id="description" name="description" class="block w-full p-2 mt-1 border rounded-md" rows="4">{!! old('description', $promotion->description) !!}</textarea>
                    </div>
                </div>
