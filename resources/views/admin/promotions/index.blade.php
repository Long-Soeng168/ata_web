        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                        ...
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-start justify-center gap-3">
                                    <x-add-more-button identifier="{{ $promotion->id }}"
                                        addMoreUrl="{{ route('admin.addmore') }}" tooltipText="Add More" />
                                    <x-view-detail-button identifier="{{ $promotion->id }}"
                                        viewDetailUrl="{{ route('admin.promotions.show', $promotion->id) }}"
                                        tooltipText=" View item details" />
                                    <x-delete-confirm-button identifier="{{ $promotion->id }}"
                                        deleteUrl="{{ route('admin.promotions.destroy', $promotion->id) }}"
                                        message="Are you sure you want to delete this Item" tooltipText="Delete item" />
                                    <x-edit-button identifier="{{ $promotion->id }}"
                                        editUrl="{{ route('admin.promotions.edit', $promotion->id) }}"
                    ...
                    @empty
                        <tr>
                            <td class="px-4 py-4">No promotion</td>
                        </tr>
                    @endforelse
            ...
            <div class="p-4">
                {{-- {{ $promotions->links() }} --}}
                {{-- {{ $promotions->appends(['sort_by' => $sortColumn, 'sort_direction' => $sortDirection])->links() }} --}}
            </div>
        </div>
    </div>
@endsection
