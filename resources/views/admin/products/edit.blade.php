        ...
        <form class="w-full" action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid mt-4 md:grid-cols-3 md:gap-6">
                ...
                <div>
                    ...
                    <x-text-input id="code" class="block w-full mt-1" type="text" name="code" value="{{ old('code', $product->code) }}"
                        placeholder="Code" />
                ...
                <div>
                    ...
                    <x-text-input id="discount" class="block w-full mt-1" type="number" name="discount_percent"
                        value="{{ old('discount_percent', $product->discount_percent) }}" placeholder="Discount" />
                ...
                <div class="relative z-0 w-full group">
                    ...
                    <x-select-option id="body_type_id" name="body_type_id">
                        ...
                        @forelse ($body_types as $body_type)
                            <option value="{{ $body_type->id }}" {{ $product->body_type_id == $body_type->id ? 'selected' : '' }}>{{ $body_type->name }}</option>
                        @empty
            ...
            <div class="mt-5 mb-5">
                <div class="flex items-center space-4">
                    <div class="max-w-40">
                        <img id="selected-image" src="{{ asset('assets/images/products/' . $product->image) }}" alt="Selected Image"
            ...
            <div class="mb-5">
                ...
                <textarea id="description" name="description" class="block w-full mt-1" rows="4">{{ old('description', $product->description) }}</textarea>
            </div>
